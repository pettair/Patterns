...
import patterns.structuralpatterns.ConcreteFlyWeightB;
...
public class ConcreteFactoryB extends AbstractFactory {
	...
	public ConcreteFactoryB(){
		_color = SingletonPattern.getMainColor(false);
		_color2 =SingletonPattern.getSecondColor(false);
		fly = new ConcreteFlyWeightB();
	}
